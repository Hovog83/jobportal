        ...
        <?= $this->Form->create($user); ?>
          <div class="form-group">
            <div class="input-group">
              ...
              <?= $this->Form->input('username',['label' => false , 'placeholder' => 'Enter company name','class'=>"form-control"]);?>
              <?= $this->Form->input('role',['type'=>'hidden','value'=>'company'])?>
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <?= $this->Form->input('first_name', ['type' => 'text' , 'placeholder' => 'First Name' , 'label' => false,'class'=> 'form-control']);;?>
              <!-- <input type="password" class="form-control" placeholder="Choose a password"> -->
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="input-group">
              <span class="input-group-addon"></span>
              <?= $this->Form->input('last_name', ['type' => 'text' , 'placeholder' => 'Last Name' , 'label' => false,'class'=> 'form-control']);;?>
              <!-- <input type="password" class="form-control" placeholder="Choose a password"> -->
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="input-group">
              <span class="input-group-addon"></span>
              <?= $this->Form->input('work_phon', ['type' => 'text' , 'placeholder' => 'Work Phon' , 'label' => false,'class'=> 'form-control']);;?> <!-- <input type="password" class="form-control" placeholder="Choose a password"> -->
            </div>
          </div>
