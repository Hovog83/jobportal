...
<?php echo $this->element('english/header'); ?>
 <?php echo $this->form->create($company_profile,[ 'type'=>'file']); ?>
      <!-- Page header -->
            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-lg-2">
                  ...
                  <?php echo $this->form->input('Company_profile.cover',['type'=>'file','class'=>'dropify logoImage','data-default-file'=>'/jobportal/img/logo-default.png']) ?>
                ...
                <div class="col-xs-12 col-sm-8 col-lg-10">
                  <div class="form-group">
                  <?php echo $this->form->input('comapny_name',['class'=>'form-control input-lg','placeholder'=>'Comapny name','label'=>false]) ?>
                  </div>
                  <div class="form-group">
                  <?php echo $this->form->input('headline',['class'=>'form-control','placeholder'=>'Headline (e.g. Internet and computer software)','label'=>false]) ?>
                    <!-- <input type="text" class="form-control" placeholder="Headline (e.g. Internet and computer software)"> -->
                  </div>

                  <div class="form-group">
                  <?php echo $this->form->textarea('short_description',['class'=>'form-control','placeholder'=>'Short description','label'=>false,'rows'=>3]) ?>
            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                  ...
                  <?php echo $this->form->input('location',['class'=>'form-control','placeholder'=>'Location, e.g. Melon Park, CA','label'=>false]) ?>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                  <div class="input-group input-group-sm">
                    ...
                    <?php echo $this->form->input('website_address',['class'=>'form-control','placeholder'=>'Website address','label'=>false]) ?>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                  <div class="input-group input-group-sm">
                    <span class="input-group-addon"><i class="fa fa-birthday-cake"></i></span>
                     <?php //echo $this->form->input('founded',['class'=>'form-control','placeholder'=>'Founded on, e.g. 2013','label'=>false]) ?>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                  <div class="input-group input-group-sm">
                    ...
                    <?php echo $this->form->input('phone_number',['class'=>'form-control','placeholder'=>'Phone number','label'=>false]) ?>
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                  <div class="input-group input-group-sm">
                    ...
                    <?php echo $this->form->input('email_address',['class'=>'form-control','placeholder'=>'Email address','label'=>false]) ?>
            ...
            <div class="action-buttons">
              <div class="upload-button">
                <button class="btn btn-block btn-primary">Choose a cover image</button>
                 <?php echo $this->Form->input('Company_profile.logo', array('type' => 'file', 'label' => false, 'id' => 'cover_img_file','class'=>'image')); ?>
        ...
        <section class=" bg-alt">
          <div class="container">
            ...
            <header class="section-header">
              ...
              <?php echo $this->form->textarea('summernote_editor',['class'=>'summernote-editor','label'=>false]) ?>
